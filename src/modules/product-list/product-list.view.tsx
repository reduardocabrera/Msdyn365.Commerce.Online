...
import { IProductListViewProps, IProductComponentViewProps } from './product-list';
import { IProductListResources } from './product-list.props.autogenerated';
...
const _renderNoProduct = (resources: IProductListResources): JSX.Element => {
    return (
        <Node className={''}>
